...
mkdir -p results/logs results/metrics results/figures results/artifacts models ollama_models
...
python scripts/run_experiment.py --config configs/experiment_v3_sol.json
